function init() {
	...
	// ADARSH
    LoadVideoSource("http://nimbuscdn-nimbuspm.streaming.mediaservices.windows.net/f06ac097-08a4-4ca4-b45c-e5b5cd3f4c7f/Hololens Demo.mp4");
    $("#ttURL").val("http://nimbuscdn-nimbuspm.streaming.mediaservices.windows.net/e0ebde47-db9a-4e79-9d72-1a8f6afba7ba/Hololens Demo.mp4.ttml");
    $("#loadCaptionFileFromUrl").click();

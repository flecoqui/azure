function init() {
    ...
    function LoadVideoSource(s) {
        ...
        //        $("#audioElm").css("display", "block").attr("src", fr.result).prop("controls", true).get(0).load();
        //    };
   ...
   //     oReq.send();
        ...
        if (s != "") {
            $("#videoError").css("display", "none");
            $("#audioElm").css("display", "block").attr("src", s).prop("controls", true).get(0).load();
        }
    }
    ...
    function videoPauseEventHandler() {
        ...
        var playTime = $("#audioElm").prop("currentTime");
    ...
    function RefreshMarkupDisplay() {
        var videoName = $("#audioElm").attr("src");
    ...
    function SaveCaptionAsTextBlob(s) {
        var filename = $("#audioElm").attr("src");
        if (filename) {
    ...
    var audiourl = b64DecodeUnicode(getUrlVars()["audiourl"]);
    var ttmlurl = b64DecodeUnicode(getUrlVars()["ttmlurl"]);
    if (typeof audiourl === 'undefined') {
        //audiourl = "http://nimbuscdn-nimbuspm.streaming.mediaservices.windows.net/ca7a6b32-8ec7-45a6-8db7-0260d3cd4b4f/spanish_H264_2200kbps_AAC_und_ch_1280x720_3400.mp4";
        audiourl = "http://blobstoragebackup.blob.core.windows.net/testams/11598-12.12.2016-ITEMA_21162767-0.mp3";
       // audiourl = "http://blobstoragebackup.blob.core.windows.net/testams/14212-07.12.2016-ITEMA_21158276-0.mp3";
    }
    if (typeof ttmlurl === 'undefined') {
      //  ttmlurl = "http://nimbuscdn-nimbuspm.streaming.mediaservices.windows.net/6b1c84cb-299e-4fb0-8bf6-f456c2c81b8d/spanish_H264_2200kbps_AAC_und_ch2_128kbps.mp4.ttml";
        ttmlurl = "http://blobstoragebackup.blob.core.windows.net/testams/11598-12.12.2016-ITEMA_21162767-0_aud_SpReco.ttml";
       // ttmlurl = "http://blobstoragebackup.blob.core.windows.net/testams/14212-07.12.2016-ITEMA_21158276-0_aud_SpReco.ttml";
    }
    LoadVideoSource(audiourl);
    $("#ttURL").val(ttmlurl);
  //  LoadVideoSource("http://blobstoragebackup.blob.core.windows.net/testams/11598-12.12.2016-ITEMA_21162767-0.mp3");
  //  $("#ttURL").val("http://blobstoragebackup.blob.core.windows.net/testams/11598-12.12.2016-ITEMA_21162767-0_aud_SpReco.ttml");

//        LoadVideoSource("http://blobstoragebackup.blob.core.windows.net/testams/14212-07.12.2016-ITEMA_21158276-0.mp3");
//    $("#ttURL").val("http://blobstoragebackup.blob.core.windows.net/testams/14212-07.12.2016-ITEMA_21158276-0_aud_SpReco.ttml");


//        LoadVideoSource("http://nimbuscdn-nimbuspm.streaming.mediaservices.windows.net/ca7a6b32-8ec7-45a6-8db7-0260d3cd4b4f/spanish_H264_2200kbps_AAC_und_ch_1280x720_3400.mp4");
//        $("#ttURL").val("http://blobstoragebackup.blob.core.windows.net/testams/14212-07.12.2016-ITEMA_21158276-0_aud_SpReco.ttml");
    //    $("#ttURL").val("http://nimbuscdn-nimbuspm.streaming.mediaservices.windows.net/6b1c84cb-299e-4fb0-8bf6-f456c2c81b8d/spanish_H264_2200kbps_AAC_und_ch2_128kbps.mp4.ttml");
    $("#loadCaptionFileFromUrl").click();
}
